<template>
  ...
  <footer>
    <div class="flex-col mx-auto w-full md:max-w-4xl lg:max-w-7xl md:flex px-2 py-10 md:px-4 md:py-15">
      <!-- TOP CONTAINER -->
      <div class=" md:flex md:flex-row md:justify-between">
        ...
        <div>
          ...
          <p class=" mt-4 max-w-80 text-base font-light text-white">
            Mermeme Coin is a meme coin that washed up on the crypto beach, bringing bubbles and questionable decisions.
          </p>
          <!-- SOCIAL MEDIA ICONS -->
          <div class="mb-8 mt-6 flex flex-row">
            <a href="" class="mr-4 text-white transition hover:text-green-400">
            ...
            <a href="" class="mx-4 text-white transition hover:text-green-400">
              <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="mt-10 flex flex-col  md:mt-0">
          ...
          <div class="mb-4 flex flex-row items-center max-w-72">
            ...
            <p class=" ml-4 text-white">support@mermemecoin.com</p>
          </div>
        </div>
      </div>
      <!-- Divider -->
